  ...
  return (
    <div className="my-auctions-container">
      ...
      <div className="auction-grid">
        <div
          className="add-auction-tile"
          onClick={() => navigate("/provider/add-auction")}
        >
          ...
          <div key={auction["auction-id"]} className="auction-card">
            ...
            <div className="auction-details">
              ...
              <div className="auction-actions">
                <button onClick={() => handleEdit(auction["auction-id"])}>
                  Edit
                </button>
                <button onClick={() => handleDelete(auction["auction-id"])}>
                  Delete
                </button>
              </div>
            </div>
